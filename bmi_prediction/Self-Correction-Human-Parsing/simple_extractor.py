...
def get_arguments():
    ...
    parser.add_argument("--input_csv", type=str, default='', help="path of human body detection result csv")
...
def main():
    ...
    dataset = SimpleFolderDataset(root=args.input_dir, filter=args.input_csv, input_size=input_size, transform=transform)
    ...
    with torch.no_grad():
        for _, batch in enumerate(tqdm(dataloader)):
            ...
            # !!can only save as png format, raise error if saved as jpg format
